        ...
        <main class="mt-10">
          ...
          >
            ...
            <img
              ...
              class="absolute border border-btnbrown border-l-4 rounded-md border-b-4 left-0 top-0 w-full h-full z-0 object-cover"
            />
            <div class="p-4 absolute bottom-0 left-0 z-20">
              <h2 class="text-4xl font-semibold three_h leading-tight">
          ...
          <div class="px-4 lg:px-0 mt-12 text-black max-w-screen-md mx-auto text-lg leading-relaxed">
            <p class="pb-6">
