...
const Careers = () => {
  ...
  return (
    <section className="py-20 bg-primaryyellow">
      <div className="max-w-screen-lg mx-auto px-4 md:px-8">
        ...
        <ul className="mt-12  space-y-3">
          {members.map((item, idx) => (
            <li
              key={idx}
              className="px-4 py-5 border border-btnbrown bg-btnyellow border-b-4 border-l-4 hover:border-t-4 hover:border-r-4 hover:border-b-0 hover:border-l-0 hover:ease-in-out duration-300 rounded-md "
            >
              <a href={item.path} className="space-y-3">
                <div className="flex items-center gap-x-3">
                  <div>
                    <h3 className="text-btnbrown font-semibold mt-1">
                      {item.job_title}
                    </h3>
                  </div>
                </div>
                <p className="text-btnbrown sm:text-sm">
                  {item.job_description}
                </p>
                <div className="text-sm text-btnbrown flex items-center gap-6">
