  ...
  return (
    <div>
      <div class="max-w-screen-xl mx-auto ">
        <main class="">
          <div class="px-4 lg:px-0  text-btnbrown max-w-screen-md mx-auto text-lg leading-relaxed">
            <div class=" mt-12 ">
              <h2 class="text-4xl font-semibold three_h mb-12 text-center leading-tight">
                Privacy Policy
              </h2>
            </div>
